...
void Vtop___024root__traceInitSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+3,"ledr", false,-1, 15,0);
        tracep->declBit(c+1,"top clk", false,-1);
        tracep->declBit(c+2,"top rst", false,-1);
        tracep->declBus(c+3,"top ledr", false,-1, 15,0);
        tracep->declBus(c+4,"top count", false,-1, 31,0);
        tracep->declBus(c+5,"top led", false,-1, 15,0);
    }
}
...
void Vtop___024root__traceFullSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullSData(oldp+3,(vlSelf->ledr),16);
        tracep->fullIData(oldp+4,(vlSelf->top__DOT__count),32);
        tracep->fullSData(oldp+5,(vlSelf->top__DOT__led),16);
    }
}
