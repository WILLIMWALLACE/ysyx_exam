...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
            ...
            tracep->chgSData(oldp+41,(vlSelf->top__DOT__vga_ctrl__DOT__y_cnt),10);
            tracep->chgBit(oldp+42,(vlSelf->top__DOT__vga_ctrl__DOT__h_valid));
            tracep->chgBit(oldp+43,(vlSelf->top__DOT__vga_ctrl__DOT__v_valid));
            tracep->chgSData(oldp+44,(vlSelf->top__DOT__my_keyboard__DOT__buffer),10);
            tracep->chgCData(oldp+45,(vlSelf->top__DOT__my_keyboard__DOT__ps2_clk_sync),3);
            tracep->chgCData(oldp+46,(vlSelf->top__DOT__my_keyboard__DOT__fifo[0]),8);
            tracep->chgCData(oldp+47,(vlSelf->top__DOT__my_keyboard__DOT__fifo[1]),8);
            tracep->chgCData(oldp+48,(vlSelf->top__DOT__my_keyboard__DOT__fifo[2]),8);
            tracep->chgCData(oldp+49,(vlSelf->top__DOT__my_keyboard__DOT__fifo[3]),8);
            tracep->chgCData(oldp+50,(vlSelf->top__DOT__my_keyboard__DOT__fifo[4]),8);
            tracep->chgCData(oldp+51,(vlSelf->top__DOT__my_keyboard__DOT__fifo[5]),8);
            tracep->chgCData(oldp+52,(vlSelf->top__DOT__my_keyboard__DOT__fifo[6]),8);
            tracep->chgCData(oldp+53,(vlSelf->top__DOT__my_keyboard__DOT__fifo[7]),8);
            tracep->chgCData(oldp+54,(vlSelf->top__DOT__my_keyboard__DOT__w_ptr),3);
            tracep->chgCData(oldp+55,(vlSelf->top__DOT__my_keyboard__DOT__r_ptr),3);
        }
