...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__2(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        vlSelf->top__DOT__mc = ((IData)(vlSelf->top__DOT__ready)
                                 ? vlSelf->top__DOT__my_keyboard__DOT__fifo
                                [vlSelf->top__DOT__my_keyboard__DOT__r_ptr]
                                 : 0U);
        vlSelf->top__DOT__cnt = (7U & ((IData)(vlSelf->top__DOT__ready)
                                        ? ((IData)(1U) 
    ...
    vlSelf->top__DOT__nextdata_n = (1U & ((IData)(vlSelf->rst) 
