...
void Vysyx_22040365_top___024root___ctor_var_reset(Vysyx_22040365_top___024root* vlSelf) {
    ...
    vlSelf->ysyx_22040365_top__DOT__inst_type = VL_RAND_RESET_I(8);
    vlSelf->ysyx_22040365_top__DOT__rs1_data = VL_RAND_RESET_Q(64);
    vlSelf->ysyx_22040365_top__DOT__wen_rd = VL_RAND_RESET_I(1);
    vlSelf->ysyx_22040365_top__DOT__u_ysyx_22040365_id__DOT__opcode = VL_RAND_RESET_I(7);
    for (int __Vi0=0; __Vi0<5; ++__Vi0) {
        vlSelf->ysyx_22040365_top__DOT__u_ysyx_22040365_regfile__DOT__rf[__Vi0] = VL_RAND_RESET_Q(64);
    }
    vlSelf->ysyx_22040365_top__DOT__u_ysyx_22040365_regfile__DOT____Vlvbound1 = VL_RAND_RESET_Q(64);
