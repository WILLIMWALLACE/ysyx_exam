...
void Vysyx_22040365_top___024root__traceChgSub0(Vysyx_22040365_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgBit(oldp+10,((IData)((0x10U == (0x707cU 
                                                   & vlSelf->inst)))));
        tracep->chgCData(oldp+11,((0x1fU & (vlSelf->inst 
                                            >> 0xfU))),5);
        tracep->chgCData(oldp+12,((0x1fU & (vlSelf->inst 
                                            >> 7U))),5);
        tracep->chgQData(oldp+13,((((- (QData)((IData)(
                                    ...
                                    << 0xcU) | (QData)((IData)(
                                                               (vlSelf->inst 
                                                                >> 0x14U))))),64);
        tracep->chgQData(oldp+15,(((2U >= (3U & (vlSelf->inst 
                                                 >> 0xfU)))
                                    ? vlSelf->ysyx_22040365_top__DOT__u_ysyx_22040365_regfile__DOT__rf
                                   [(3U & (vlSelf->inst 
                                           >> 0xfU))]
                                    : 0ULL)),64);
        tracep->chgQData(oldp+17,(vlSelf->ysyx_22040365_top__DOT__rd_data),64);
        tracep->chgCData(oldp+19,((0x7fU & vlSelf->inst)),7);
        tracep->chgCData(oldp+20,((7U & (vlSelf->inst 
                                         >> 0xcU))),3);
