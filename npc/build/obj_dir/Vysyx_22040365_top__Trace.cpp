...
void Vysyx_22040365_top___024root__traceChgSub0(Vysyx_22040365_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgIData(oldp+11,(vlSelf->inst),32);
        tracep->chgQData(oldp+12,(vlSelf->out),64);
        tracep->chgBit(oldp+14,((IData)((0x13U == (0x707fU 
                                                   & vlSelf->inst)))));
        ...
        tracep->chgQData(oldp+17,((((- (QData)((IData)(
                                    ...
                                    << 0xcU) | (QData)((IData)(
                                                               (vlSelf->inst 
                                                                >> 0x14U))))),64);
        tracep->chgQData(oldp+19,(((4U >= (7U & (vlSelf->inst 
                                                 >> 0xfU)))
                                    ? vlSelf->ysyx_22040365_top__DOT__u_ysyx_22040365_regfile__DOT__regs
                                   [(7U & (vlSelf->inst 
                                           >> 0xfU))]
                                    : 0ULL)),64);
        tracep->chgQData(oldp+21,(vlSelf->ysyx_22040365_top__DOT__rd_data),64);
        tracep->chgCData(oldp+23,((0x7fU & vlSelf->inst)),7);
        tracep->chgCData(oldp+24,((7U & (vlSelf->inst 
                                         >> 0xcU))),3);
    }
}
